...
if(isset($_POST["submit"])){
          //$id=3;
          $umworozi=$_POST["umworozi"];
          //$invoice_date=date("Y-m-d",strtotime($_POST["invoice_date"]));
          //$lname=mysqli_real_escape_string($con,$_POST["lname"]);
          $vite=mysqli_real_escape_string($con,$_POST["vite"]);
          ...
          $sql="insert into dasoft_bookviterinarian (Umworozi,Viterinarian_Name,Department_Name,Phone_Number,Symptoms,Date) values ('{$umworozi}','{$vite}','{$depart}','{$phone}','{$Symptoms}','{$date}') ";
          If($con->query($sql)){

          echo "hi oky!!!!SSSSSSSSS";
        }}
        else
        {
          echo"simpari ";
      ...
      // echo $email;
        ...
        //}
        echo "Welcome, " . $_SESSION["Username"].$_SESSION["User_id"];
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <div class="d-flex mr-auto flex-column flex-lg-row align-items-center">
                <ul class="navbar-nav  ">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="doctor.html">Ibiraro</a>
                  </li>
                  <li class="nav-item">
      ...
      <div class="row">
        <div class="col">
          <form method="post" action="index.php">
            <h4>
              BOOK <span>APPOINTMENT WITH OUR VETERINARIANS </span>
            </h4>

            <div class="form-row ">
              <div class="form-group col-lg-4">
                <label for="inputPatientName">Umworozi </label>
                <input type="text" name="umworozi" class="form-control" id="inputPatientName" placeholder="">
              </div>
              <div class="form-group col-lg-4">
                <label for="inputDoctorName">Viterinarian's Name</label>
                <select name="vite" class="form-control wide" id="inputDoctorName">
                  <option value="Normal distribution ">TUYISHIME ERIC </option>
                  <option value="Normal distribution ">AKIMANA LETITIA </option>
                  <option value="Normal distribution ">MUGANYINKA RACHEL </option>
                </select>
              </div>
              <div class="form-group col-lg-4">
                <label for="inputDepartmentName">Department's Name</label>
                <select name="depart" class="form-control wide" id="inputDepartmentName">
                  <option value="Normal distribution ">Cattle Farming</option>
                  <option value="Normal distribution ">Poultry Farming </option>
                  <option value="Normal distribution ">Others </option>
                </select>
              </div>
            </div>
            <div class="form-row ">
  ...
  <footer class="footer_section">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">EM tech Ltd</a>
      </p>
    </div>
  </footer>
  <!-- footer section -->
